...
def default_ops():
    ...
    # Suite2p version
        'suite2p_version':
        version,    #current version of suite2p used for pipeline
    ...
    # file input/output settings
        ...
        'save_folder':
        [],    # directory you'd like suite2p results to be saved to
        'subfolders':
    ...
    # registration settings
        'do_registration':
        True,    # whether to register data (2 forces re-registration)
        ...
        'force_refImg':
        False,    # if True, use refImg stored in ops if available
        'pad_fft':
        False,    # if True, pads image during FFT part of registration
    ...
    # cell detection settings with suite2p
        ...
        'max_iterations':
        20,    # maximum number of iterations to do cell detection
        'threshold_scaling':
        ...
        'denoise':
        False,    # denoise binned movie for cell detection in sparse_mode
    ...
    # cell detection settings with cellpose (used if anatomical_only > 0)
        ...
        'spatial_hp_cp':
        0,    # high-pass image spatially by a multiple of the diameter
        'pretrained_model':
    ...
    # ROI extraction parameters
        ...
        'min_neuropil_pixels':
        350,    # minimum number of pixels in the neuropil
        'lam_percentile':
