...
If this is the case, in python, we recommend the package [ROICaT](https://github.com/RichieHakim/ROICaT) by Richard Hakim. In matlab, we recommend [ROIMatchPub](https://github.com/ransona/ROIMatchPub) by Adam Ranson (which is based on similar concepts as ‘registers2p’ by Henry Dalgleish). Both take the outputs of Suite2p directly.
