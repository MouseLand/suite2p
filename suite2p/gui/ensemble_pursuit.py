...
class BoxLayout(pg.LayoutWidget):
    '''
    Custom box layout for box buttons. Supports clearing the boxes when flippping
    through multiple pages.
    '''
    def __init__(self, ep_win):
        super(BoxLayout, self).__init__()
        self.layout = QtGui.QGridLayout()
        ep_win.l0.addWidget(self.layout,1,1,4,12)
...
class EPWindow(QtGui.QMainWindow):
    ...
    def __init__(self, parent=None):
        ...
        self.l0.addWidget(self.sc_plots,6,0,14,14)
        ...
        if self.type_of_plot=='boxes':
            ...
            self.l0.addWidget(box_widget,1,1,4,12)
    ...
    def make_top(self,parent):
        ...
        self.l0.addWidget(self.nr_ens_text,  0, 2.5, 1, 2)
        ...
        self.l0.addWidget(self.lam_text,  0, 5.5, 1, 1)
    ...
    def make_data_selector(self,parent):
        ...
        self.l0.addWidget(self.data_selector,5,0,1,2)
        ...
        self.l0.addWidget(ind_text,  5, 2, 1, 1)
        ...
        self.l0.addWidget(self.enter_ind, 5,3, 1, 1)
        self.ind=int(self.enter_ind.text())

        self.range=RangeWidget(self)
        self.l0.addWidget(self.range,5,5,1,1)
