...
In this case, (if you have a matlab license) here is a package written by Adam Ranson which is based on similar concepts as ‘registers2p’ by Henry Dalgleish that takes the output of suite2p-python directly: [https://github.com/ransona/ROIMatchPub](https://github.com/ransona/ROIMatchPub).
