...
def get_stat_iscell(data_dir_path):
    ...
    stat = np.load(data_dir_path.joinpath('classification_input/pre_stat.npy'), allow_pickle=True)
    expected_output = np.load(data_dir_path.joinpath('classification/expected_classify_output_1p1c0.npy'))
